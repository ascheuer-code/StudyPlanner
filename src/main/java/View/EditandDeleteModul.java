...
public class EditandDeleteModul {
     ...
     *         the button
     */
    public void editModul(Modul editModul, Button button, EntityManager entityManager, EntityTransaction entityTransaction, List<Modul> Module, ListView listbox, List<Event> Events, Calendar SchoolTimeTable, Calendar StudyPlan) {
    ...
    public void modullöschen(List<Modul> Module,List<Event> Events, Calendar SchoolTimeTable,
                             Calendar StudyPlan,EntityManager entityManager, EntityTransaction entityTransaction,ListView<Button> listbox) {
        // Layout des aufgehenden Fensters
        Stage stage = new Stage();
