...
public class ShowQuotes {
        ...
        public void showQuotes() {
                ...
                List<String> gutzuwissen = new ArrayList<>();

                // List for the button contents
                List<String> buttoncontents = new ArrayList<>();
                ...
                gutzuwissen
                                .add("\"Gerade Leute, die nichts lernen, lernen auch nichts daraus, dass sie nichts gelernt haben.\"");
                ...
                gutzuwissen.add(
                                "\"Wer Erfolg haben will, muss lernen, dass Misserfolge gesunde, unvermeidliche Schritte auf dem Weg nach ganz oben sind.\"");

                // Button contents [IMPORTANT:IF YOU ADD SMK ;THINK ABOUT randomnumber to
                // update]
